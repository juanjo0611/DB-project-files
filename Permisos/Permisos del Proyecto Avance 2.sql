...
CREATE USER 'Empresa'@'localhost' IDENTIFIED BY '12345';

CREATE USER 'Universidad'@'localhost' IDENTIFIED BY '12345';

-- Tabla Egresados:
GRANT SELECT ON proyecto.Egresado TO 'Juan'@'localhost';
